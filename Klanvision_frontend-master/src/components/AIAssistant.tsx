...
export default function AIAssistant() {
  ...
  return (
    <>
      ...
      <div style={{ position: 'fixed', bottom: 'clamp(16px, 4vw, 30px)', right: 'clamp(12px, 3vw, 30px)', zIndex: 9000 }}>
        <motion.button
          initial={{ scale: 0 }}
          animate={{ 
            scale: [1, 1.05, 1],
          ...
          style={{
            width: 'clamp(48px, 7vw, 60px)', height: 'clamp(48px, 7vw, 60px)', borderRadius: '50%',
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            style={{
              position: 'fixed', bottom: 'clamp(80px, 12vw, 100px)', right: 'clamp(8px, 2vw, 30px)', zIndex: 9001,
