...
export default function ContactSection() {
  ...
  return (
    ...
    <section id="contact" style={{ background: 'white', padding: 'clamp(48px, 8vw, 80px) 0', position: 'relative', overflow: 'hidden' }}>
      ...
      <div className="container" style={{ position: 'relative' }}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.2fr] gap-12">
          ...
          <motion.div
            ...
            style={{ height: '100%' }}
          >
            <div className="card" style={{ padding: 'clamp(20px, 4vw, 40px) clamp(16px, 3.5vw, 40px) 10px', height: '100%', display: 'flex', flexDirection: 'column' }}>
              {submitted ? (
