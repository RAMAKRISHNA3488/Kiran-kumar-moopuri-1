  ...
  return (
    ...
    <footer style={{ background: '#120F17', color: 'white', position: 'relative', overflow: 'hidden' }}>
      ...
      <div className="container" style={{ position: 'relative', zIndex: 1 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1.5fr 1fr 1fr 1fr', gap: 'clamp(24px, 4vw, 48px)', padding: 'clamp(40px, 6vw, 64px) 0 clamp(32px, 5vw, 48px)' }} className="footer-grid">
        ...
        <div className="footer-bottom" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '20px 0', flexWrap: 'wrap', gap: 12 }}>
      ...
      <style>{`
        ...
        @media (max-width: 480px)  { .footer-bottom { flex-direction: column !important; text-align: center !important; } }
      `}</style>
      {/* Legal Modal Overlay */}
      <AnimatePresence>
        {activeLegal && (
          ...
          >
            ...
            >
              {/* Header */}
              <div style={{ padding: 'clamp(16px, 3vw, 24px) clamp(20px, 4vw, 32px)', borderBottom: '1px solid #F3F4F6', display: 'flex', alignItems: 'center', justifyContent: 'space-between', background: '#F9FAFB' }}>
              ...
              {/* Body */}
              <div style={{ padding: 'clamp(20px, 3vw, 32px)', maxHeight: '70dvh', overflowY: 'auto' }}>
