...
export default function PortfolioSection() {
  ...
  return (
    <section id="portfolio" style={{ background: 'white', padding: 'clamp(48px, 8vw, 80px) 0' }}>
      <div className="container">
        ...
        {/* ── Filter Tabs */}
        <div className="portfolio-tabs" style={{ display: 'flex', justifyContent: 'center', flexWrap: 'wrap', gap: 10, marginBottom: 44 }}>
          {tabs.map(tab => (
            <motion.button
              key={tab}
