...
export default function TestimonialsSection() {
  ...
  const visibleCards = containerWidth < 640 ? 1 : containerWidth < 1024 ? 2 : VISIBLE;
  // cardWidth = (containerWidth - (visibleCards-1)*GAP) / visibleCards
  // stepPx    = cardWidth + GAP  =  (containerWidth + GAP) / visibleCards
  ...
  return (
    <section id="testimonials" style={{ background: 'white', padding: 'clamp(48px, 8vw, 80px) 0' }}>
        ...
        >
          ...
          >
            {track.map((t, i) => {
              ...
              style={{
                minWidth: `calc((${containerWidth}px - ${(visibleCards - 1) * GAP}px) / ${visibleCards})`,
                maxWidth: `calc((${containerWidth}px - ${(visibleCards - 1) * GAP}px) / ${visibleCards})`,
                flexShrink: 0,
