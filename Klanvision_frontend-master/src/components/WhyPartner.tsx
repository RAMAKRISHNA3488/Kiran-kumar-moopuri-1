...
export default function WhyPartner() {
  return (
    ...
    <section id="why-partner" style={{ background: 'white', padding: 'clamp(48px, 8vw, 80px) 0' }}>
      <div className="container">
        ...
        >
          {stats.map((s, idx) => (
            ...
            >
              ...
              <div className="text-[#1F2937]" style={{ fontFamily: 'Poppins, sans-serif', fontWeight: 800, fontSize: 'clamp(28px, 5vw, 38px)', lineHeight: 1.1 }}>
        ...
        <motion.div
          ...
          style={{
            ...
            padding: 'clamp(32px, 6vw, 64px) clamp(20px, 4vw, 40px)', textAlign: 'center',
          }}
        >
